...
public class Prism extends PrismComponent implements PrismSettingsListener
{
	...
	//Heuristics for solving the model
	private boolean heuristic = false;
	private String heuristicName = null;
	private String heuristicNextStateName = "MAX_DIFF";
	private boolean heuristicVerbose = false;
	private double heuristicEpsilon = 1e-6;
	private int RTDP_ADJ_optimizations = 0; //every bit tells us about an optimization. TODO: Explain all here.
	...
	public void setHeuristicNextStateName(String name) {
		this.heuristicNextStateName = name;
	}

	public void setHeuristicVerbose(boolean verbose) {
		this.heuristicVerbose = verbose;
	}

	public void setHeuristicEpsilon(double epsilon) {
		this.heuristicEpsilon = epsilon;
	}

	public void setRTDP_ADJ_optimizations(int opt) {
		this.RTDP_ADJ_optimizations = opt;
	}
	...
	public Result modelCheck(PropertiesFile propertiesFile, Property prop, boolean computePareto) throws PrismException, PrismLangException
	{
		...
		// For heuristics solving
		if ((currentModelType == ModelType.MDP || currentModelType == ModelType.SMG) && heuristic) {
			HeuristicsSMGModelChecker hSMGMC;
			hSMGMC = new HeuristicsSMGModelChecker(this, currentModulesFile, propertiesFile, getSimulator(), heuristicName, heuristicNextStateName, heuristicVerbose, heuristicEpsilon, RTDP_ADJ_optimizations);
			return hSMGMC.check(prop.getExpression());
		}
