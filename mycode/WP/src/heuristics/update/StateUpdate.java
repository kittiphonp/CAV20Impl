...
public abstract class StateUpdate implements Cloneable {
	...
	public abstract int update(State s) throws PrismException;

	public abstract int update(State s, HashMap<State,BitSet> state2leavingActions) throws PrismException;

	public abstract ArrayList<Integer> getBestActions(State s) throws PrismException;
	...
	public boolean visitied(State s) {
