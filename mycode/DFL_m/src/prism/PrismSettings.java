...
public class PrismSettings implements Observer
{
	...
	public static final Object[][][] propertyData =
	{
		{	//Datatype:			Key:									Display name:							Version:		Default:																	Constraints:																				Comment:
			...
			{ CHOICE_TYPE,		PRISM_MDP_SOLN_METHOD,					"MDP solution method",				"MW",			"Value iteration",																"Value iteration,Gauss-Seidel,Policy iteration,Modified policy iteration,Linear programming,BVI_A,BVI_C",
	...
	public synchronized int setFromCommandLineSwitch(String args[], int i) throws PrismException
	{
		...
		}//soln_Method; used only in ProbModelChecker, more explicitly in STPGModelChecker
		else if (sw.equals("BVI_A")){
			set(PRISM_MDP_SOLN_METHOD, "BVI_A");
		}
		else if (sw.equals("BVI_C")){
			set(PRISM_MDP_SOLN_METHOD, "BVI_C");
		}
